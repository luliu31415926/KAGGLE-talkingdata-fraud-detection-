...
cPickle.dump(test_data_dict,open("../talkingdata_data/test_ip_data_dict.pkl","wb"),protocol=-1)
cPickle.dump(data_dict,open("../talkingdata_data/ip_data_dict.pkl","wb"),protocol=-1)
gc.collect();